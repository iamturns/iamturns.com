...
const PitchIntro = () => (
	<div className="wysiwyg">
		...
		<p>
			...
			in 42 browser tabs of articles, tutorials, and GitHub repos. You bookmark a handful to check
			out later (or, never).
		</p>
		<p>
		...
		<p>
			<Link to="/javascript-roundup/" className="button inline-flex items-center">
