...
const ContentDevStereotypeArticle = (props: Props) => (
	<div className="wysiwyg">
		<p>
			Introducing: Joe, the stereotypical developer in 2018. Inspired by
		...
		<p>
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (49.2%) are between the age
						of 25 and 34.
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (74.2%) are white or of
						European descent.
						<br />
		...
		<p>
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (29.5%) wake up between 7:01
						and 8:00 AM.
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (71.1%) do not have children
						or other dependents.
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (16%) are employed in the web
						development or design industry.
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers are back-end (57.9%) or
						full-stack (48.2%).
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (23.8%) are employed at
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers feel a sense of kinship or
		...
		<p>
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (52.2%) use an ergonomic
						keyboard or mouse.
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (52.7%) spend between 9 and
						12 hours on a computer.
						<br />
		...
		<p>
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (30.1%) have been coding
						professionally for less than 2 years.
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (36.5%) are moderately
						satisfied with their career &amp; job.
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (87.2%) use Git for version
						control.
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (60.2%) check in their code
		...
		<p>
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers code in JavaScript (69.8%),
						HTML (68.5%), and CSS (65.1%).
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers use Angular (36.9%) and React
						(27.8%).
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers love Redis (64.5%) and
						PostgreSQL (62%).
						<br />
						<Link to="https://insights.stackoverflow.com/survey/2018/#technology-most-loved-dreaded-and-wanted-frameworks-libraries-and-tools" />
					</div>
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers love Serverless (75.2%) and
						AWS (68.6%).
						<br />
						<Link to="https://insights.stackoverflow.com/survey/2018/#technology-most-loved-dreaded-and-wanted-platforms" />
					</div>
		...
		<p>
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (59.8%) are not actively
						looking for a job, but are open to new opportunities.
						<br />
						<Link to="https://insights.stackoverflow.com/survey/2018/#work-job-search-status" />
					</div>
				),
			})}{' '}
			Especially if they pay well, and give me experience with awesome
			tech
			{props.createFootnoteLink({
				key: 'job-criteria',
				node: (
					<div>
						The majority of developers assess potential jobs by
						compensation and benefits (18.3%), and what technology
						they will be working with (17.3%).
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers dread VB6 (89.9%), Oracle
						(63.1%), and Cordova (59.6%).
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers dread Sharepoint (71.8%),
						Drupal (70.4%), and Salesforce (69.7%).
						<br />
						<Link to="https://insights.stackoverflow.com/survey/2018/#technology-most-loved-dreaded-and-wanted-platforms" />
					</div>
				),
		...
		<p>
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers completed a Bachelor’s degree
						(46.1%).
						<br />
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers (63.7%) majored in computer
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						The majority of developers want Python (25.1%), MongoDB
						(18.6%), and Android (16%).
						<br />
						<Link to="https://insights.stackoverflow.com/survey/2018/#most-loved-dreaded-and-wanted" />
					</div>
		...
		<p>
			...
			{props.createFootnoteLink({
				...
				node: (
					<div>
						In 5 years time, the majority of developers hope to be
						working in a different or more specialized technical
						role (33.9%) or as a founder of their own company
						(25.7%).
						<br />
						<Link to="https://insights.stackoverflow.com/survey/2018/#developer-profile-ways-developers-learn-on-their-own" />
					</div>
