...
const Content = ({
	...
	<div>
		{/* prettier-ignore */}
		<div>
			<ContentSubtitle>This is a subtitle and it is a little bit longer so that it wraps over a couple of lines you see.</ContentSubtitle>
			<ContentP>
				<Emoji>😖</Emoji> Lorem ipsum <ContentA to="internal">dolor sit</ContentA> amet, <ContentA to="http://external/">consectetur adipiscing</ContentA> elit, sed do and <ContentA to="https://google.com/">this link is visited</ContentA>.
			...
			<ContentUL>
				...
				<ContentLI>List item 2 consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</ContentLI>
			...
			<ContentUL reset>
				...
				<ContentLI>
					<EmojiText emoji="☄">Listem item 2 consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</EmojiText>
				</ContentLI>
				<ContentLI>
			...
			<ContentImg image={imgSetSize} alt="Example alt text">Example caption</ContentImg>
			<ContentP>
				Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua
				Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
			</ContentP>
			...
			<ContentImg image={imgSmall} alt="Example alt text">
				Here is the caption with a <ContentA to="/">link inside</ContentA> - wow!
			</ContentImg>
			<ContentP>
				Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua
				Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
			...
			<ContentImg image={imgBig} alt="Example alt text">Example caption</ContentImg>
			<ContentP>
				Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua
				Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
			</ContentP>
			<ContentH3>Image full</ContentH3>
			<ContentImg image={imgFull} alt="Example alt text" type="fullscreen">Example caption</ContentImg>
			<ContentP>
				Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua
				Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
			</ContentP>
			<ContentH3>Image gif</ContentH3>
			<ContentImg image={IMG_SPONGEBOB} alt="Example alt text">Example caption</ContentImg>
			<ContentHR />
			<ContentP>
