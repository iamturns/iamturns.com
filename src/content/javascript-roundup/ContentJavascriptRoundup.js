...
const ContentJavascriptRoundup = ({
	data: { currentContent },
}: ContentProps) => (
	<div>
		...
		<PageContainer small className="wysiwyg">
			...
			<p>
				...
				Even a quick skim of the report keeps me in the loop.
			</p>
			<p>
		...
		<PageContainer small className="wysiwyg">
			<p>
				...
				<ul>
					...
					<li>
						Surfaces only the best from the biggest online
						platforms.
						<div className="text-sm">
							(like Hacker News, Twitter, Medium, GitHub, Reddit,
							and YouTube)
						</div>
					</li>
					<li>
						...
						<div className="text-sm">
							(like articles, tutorials, discussions, code,
							tweets, videos, and podcasts)
						</div>
					</li>
					<li>
			...
			<div className="my-4">
				<EmailPlease
					list="javascript-roundup"
					id="javascript-roundup"
					hideFooter
				/>
			</div>
